          ...
          <section class="category" id="caty1" id="<?php echo $cat_element; ?>"><a name="<?php echo $cat_element; ?>">
              ...
              ?>
                <div class="cotoner-child" id="produit1">
                  <button class="produit" onclick="affichage_over('<?php echo $index; ?>')">
                  ...
                  <div class="afichage ident frame" id='<?php echo $index ?>'>
                    ...
                    <button id="Annuler" onclick="affichage_out('<?php echo $index; ?>')">Annuler</button>
                  </div>
                </div>
              <?php $index++;
                }?>
